...
import flesh from "../../media/Vector5.svg"
import edit2 from "../../media/Vector6.svg"
...

            {
                ...
                <>
                    ...
                    <div className="practice-page2-modal">
                        <div className="practice-page2-modal-moving">
                            <img className="practice-page2-modal-moving-img" src={flesh} alt={flesh}/>
                            جابجا کردن
                        </div>
                        <div className="practice-page2-modal-border"/>
